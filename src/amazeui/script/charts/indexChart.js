(function () {
    ...
    if (document.body.contains(document.getElementById("widget-chart-box-1"))) {
        var myChart = echarts.init(document.getElementById("widget-chart-box-1"));
        myChart.setOption(option);
    }
    if (document.body.contains(document.getElementById("widget-chart-box-2"))) {
...
(function () {
    ...
    if (document.body.contains(document.getElementById("index-pie-1"))) {
...
(function () {
    ...
    if (document.body.contains(document.getElementById("index-bar-1"))) {
...
(function () {
    ...
    if (document.body.contains(document.getElementById("index-line-1"))) {
