...
window.Win10 = {
    ...
    _hideShortcut:function () {
        var that=$("body.window #win10-shortcuts .shortcut");
	...
	_checkBgUrls:function () {
		var loaders=$('body.window>.img-loader');
		var flag=false;
    ...
    _setBackgroundImg:function (img) {
        $('body.window').css('background-image','url('+img+')')
    },
    ...
    _checkTop:function () {
        ...
        $("#win10_btn_group_middle .win-btn.show").each(function () {
        ...
        $("#win10_btn_group_middle .win-btn").removeClass('active');
        if(btn){
            btn.addClass('active');
        }
    },
    ...
    _bind_open_windows:function () {
        /* 注册事件委派 打开url窗口*/
        $('body.window').on('click', '.win10-open-window', function() {
            /*>> 获取当前点击的对象*/
            $this = $(this);
    ...
    _init:function () {
        ...
        $("body.window .desktop").click(function () {
            Win10.menuClose();
            Win10.commandCenterClose();
        });
        $('body.window').on('click',".msg .btn_close_msg", function () {
            var msg = $(this).parent();
        ...
        /*设置默认右键菜单 */
        Win10.setContextMenu('body.window',true);
        Win10.setContextMenu('body.window>.desktop',[
        ...
        if($("#win10-desktop-scene").length<1) {
            ...
            $("body.window .desktop").append("<div id='win10-desktop-scene' style='width: 100%;height: calc(100% - 40px);position: absolute;left: 0;top: 0; z-index: 0;background-color: transparent;'></div>")
        }
    ...
    renderShortcuts:function () {
        var h=parseInt($("body.window #win10-shortcuts")[0].offsetHeight/100);
        var x=0,y=0;
        $("body.window #win10-shortcuts .shortcut").each(function () {
            $(this).css({
                left:x*82+10,
                top:y*100+10,
            });
    ...
    openUrl: function (url, title,areaAndOffset) {
        ...
        $('#win10_btn_group_middle win-btn.active').removeClass('active');
        var btn = $('<div id="win10_' + index + '" index="' + index + '" class="win-btn show active"><div class="btn_title">' + title + '</div><div class="btn_close fa fa-close"></div></div>');
    ...
    aboutUs: function() {
        ...
        layer.open({
            ...
            title: '宏邦商户平台 WIN10-UI '+this._version,
    ...
    showWins:function () {
        $('#win10_btn_group_middle>.win-btn').each(function () {
            var index = $(this).attr('index');
            var layero = Win10.getLayeroByIndex(index);
            $(this).addClass('show');
            layero.show();
