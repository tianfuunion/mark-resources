...
Home.zoom = (function(){
	return {
		...
		**  需要注意的是onchange参数，调用的是Home.zoom.check方法
		*/
		init : function(){
			...
			*/
			swfobject.embedSWF(staticUrl + 'js/zoom.swf?onchange=Home.zoom.check', 'zoombox', '10', '10', '6.0.0', 'expressInstall.swf', '', {allowScriptAccess : 'always', wmode : 'transparent', scale : 'noScale'}, {id : 'accessory_zoom', name : 'zoom_detect'});
		},
		/*
		**  为什么会有个参数o？其实我也不知道
