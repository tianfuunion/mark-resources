...
var hiprint = function (t) {
    ...
    jQuery, n = "connected", i = "reconnecting", window.hiwebSocket = {
        ...
        start: function start() {
			console.info("HiPrint.Bundle::window.WebSocket");
			/*
            var _this = this;
    ...
    var _o,
        ...
        mt = function () {
            ...
            return t.prototype.getProxyTarget = function () {
                ...
                this.removeTempContainer(), $("body").append($('<div class="hiprint_temp_Container hiprint-printPaper" style="overflow:hidden;height: 0;box-sizing: border-box;"></div>'));
        ...
        Ie = function () {
            ...
            return t.prototype.design = function (t, e) {
                ...
                this.removeTempContainer(), $("body").prepend($('<div class="hiprint_temp_Container" style="overflow:hidden;height: 0;box-sizing: border-box;"></div>'));
            }, t.prototype.removeTempContainer = function () {
                $(".hiprint_temp_Container").remove();
            }, t.prototype.getTempContainer = function () {
                return $(".hiprint_temp_Container");
