...
MyAjax.prototype.handle = function(d, f) {
	...
	this.transit = !1,
	this.stop = this.erromsg = !1,
	i = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP"),
	j.type = j.type.toUpperCase(),
	h = function() {},
	"string" == typeof j.data ? (j.data = j.data.replace(/(^\s*)|(\s*$)/g, ""),
	h = function() {
		i.setRequestHeader("Content-Type", "application/x-www-form-urlencoded")
	}) : "[object FormData]" !== Object.prototype.toString.call(j.data) ? (j.data = "", h = function() {
		i.setRequestHeader("Content-Type", "application/x-www-form-urlencoded")
	}) : ("function" == typeof j.progress && i.upload.addEventListener("progress", j.progress, !1), j.type = "POST"),
	g = "" == j.data ? [null, ""] : [j.data, "?" + j.data],
	l = this,
	"function" == typeof j.complete && j.complete(),
	j.timeout && j.async && (this.timeout = setTimeout(function() {
		l.out(j)
