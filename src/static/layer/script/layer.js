    ...
    var i, n, a = e.layui && layui.define,
        ...
        r = {
            ...
            ready: function (e) {
                var t = "skinlayercss",
                    i = "1110";
                return a ? layui.addcss("modules/layer/default/layer.css?v=" + r.v + i, e, t) : r.link("../style/layer.css?v=" + r.v + i, e, t), this;
			},
            ...
            switch ("string" == typeof t.area && (t.area = "auto" === t.area ? ["", ""] : [t.area, ""]), t.shift &&
                ...
                case 4:
                    f || (t.content = [t.content, "body"]), t.follow = t.content[1], t.content = t.content[0] +
                        '<i class="layui-layer-TipsG"></i>', delete t.title, t.tips = "object" == typeof t.tips ? t.tips : [t.tips, !0], t.tipsMore || r.closeAll("tips")
            }
        ...
        return r.open(i.extend({
            ...
            content: '<ul class="layui-layer-tabmain">' + function () {
                var e = t.length,
                    ...
                    n = "";
                if (e > 0)
                    for (n = '<li class="layui-layer-tabli xubox_tab_layer">' + (t[0].content || "no content") + "</li>"; i < e; i++) n +=
            ...
            l.imgprev = function (e) {
                ...
                r.close(l.loadi), l.index = r.open(i.extend({
                    ...
                    content: '<div class="layui-layer-phimg"><img src="' + d[u].src + '" alt="' +
                        ...
                        '"><span class="layui-layer-imgtit"><a href="javascript:;">' + (d[u].alt || "") + "</a><em>" + l.imgIndex + "/" + d.length + "</em></span></div></div></div>",
